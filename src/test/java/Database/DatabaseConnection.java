...
public class DatabaseConnection {
    ...
    //Facem o metoda care sa construiasca interactiunea cu baza de date
    private  void createConnection(){
        ...
        String conectionUrl = "jdbc:mysql://localhost:"+testData.get("port")+
                "/"+testData.get("databasename")+"?allowPublicKeyRetrieval=true&useSSL=false";
        try {
            connection = DriverManager.getConnection(conectionUrl,testData.get("username"),
